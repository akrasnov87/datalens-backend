...
class DefaultBasicExtAggregationTestSuite(
    ...
    def test_lod_fixed_single_dim_in_two_dim_query(
        self,
    ...
    def test_lod_in_order_by(
        ...
        def get_data(order_by: list[ResultField | OrderedField]) -> list:
            result_resp = data_api.get_result(
                dataset=ds,
                fields=[
...
class DefaultBasicLookupFunctionTestSuite(
    ...
    def test_ago_any_db_multisource(
        self,
        request: pytest.FixtureRequest,
        control_api: SyncHttpDatasetApiV1,
        data_api: SyncHttpDataApiV2,
    ...
    def test_month_ago_for_shorter_month(
        self,
        request: pytest.FixtureRequest,
        control_api: SyncHttpDatasetApiV1,
        data_api: SyncHttpDataApiV2,
